...
class LTA_Applicants_Plugin {
    ...
    private function create_table() {
        ...
        $wpdb->query("DROP TABLE IF EXISTS $applicants_table");
        
        // Create applicants table with correct structure
        $applicants_sql = "CREATE TABLE $applicants_table (
        ...
        // Log table creation
        error_log("LTA Applicants table created: $applicants_table");
    }
