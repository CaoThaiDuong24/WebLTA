  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let description = 'Đã tạo tin tuyển dụng mới'
        ...
        toast({ title: '❌ Lỗi', description: error.message || 'Không thể tạo tin tuyển dụng', variant: 'destructive' })
      }
    } catch (error) {
      console.error('Error creating recruitment:', error)
      toast({ title: '❌ Lỗi', description: 'Lỗi khi tạo tin tuyển dụng', variant: 'destructive' })
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Tạo tin tuyển dụng mới</h1>
            <p className="text-gray-600 dark:text-gray-400">Thêm tin tuyển dụng mới vào hệ thống</p>
          </div>
        </div>
      </div>
